...
<ul class="layui-nav">
    ...
    <li class="layui-nav-item" style="position:absolute;right:100px">
        <div id="search" class="layui-icon layui-icon-search" style="cursor: pointer;font-size:25px"></div>
    </li>
</ul>
    ...
    <div id="register-body" style="position: relative">
        ...
        <form id="form1" class="layui-form" action="" style="padding-top: 100px!important;">
            ...
            <div class="layui-form-item" id="submit1">
                <div class="layui-input-block">
                    <button class="layui-btn hvr-pulse-grow" lay-submit lay-filter="formDemo" id="submit-yes1">提交
                    </button>
                    <br><br>
                    <button type="reset" class="layui-btn layui-btn-primary hvr-wobble-skew" id="submit-no">重置</button>
                </div>
            </div>
        </form>
    </div>
