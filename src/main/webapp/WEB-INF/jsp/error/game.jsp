...
<div class="chest">
    ...
    <div class="chest-drawer chest-drawer--top">
        ...
        <div class="chest-drawer__structure">
            ...
            <div class="chest-drawer__panel chest-drawer__panel--back">彩蛋</div>
        </div>
    </div>
    <div class="chest-drawer chest-drawer--middle">
        ...
        <div class="chest-drawer__structure">
            ...
            <div class="chest-drawer__panel chest-drawer__panel--right"></div>
            <div class="chest-drawer__panel chest-drawer__panel--bottom"></div>
            <div class="chest-drawer__panel chest-drawer__panel--back">一个</div>
        </div>
    </div>
    <div class="chest-drawer chest-drawer--bottom">
        ...
        <div class="chest-drawer__structure">
            ...
            <div class="chest-drawer__panel chest-drawer__panel--right"></div>
            <div class="chest-drawer__panel chest-drawer__panel--bottom"></div>
            <div class="chest-drawer__panel chest-drawer__panel--back">这是</div>
        </div>
    </div>
</div>
<p style="font-size: 45px;color: white;margin-top: -16%;">抽屉</p>
</body>
</html>
