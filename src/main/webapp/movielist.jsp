...
<div class="layui-container" id="container">
    <div class="layui-fluid">
        <div id="filter">
            ...
            <button type="reset" class="Sbtn layui-btn layui-btn-danger" id="filter-reset"
                    style="display: none;width: 60px">重置
            </button>
            <button type="button" class="Sbtn layui-btn layui-btn-normal" id="filter-button"
                    style="display: block;width: 60px">筛选
            </button>
            <!-- 搜索框 -->
