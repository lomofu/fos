...
CREATE TABLE `tb_user`  (
  ...
  `sex` bit(2) NULL DEFAULT NULL COMMENT '性别0男 1女 ',
  ...
  `state` bit(2) NOT NULL COMMENT '登陆状态（‘0’未登陆 ，‘1’登陆状态）',
  `user_type` bit(2) NULL DEFAULT NULL COMMENT '用户类型（‘0’普通用户 ‘1’超级管理员）',
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (1, 'lomofu', 'lomofu', b'00', 20, NULL, NULL, NULL, '2019-05-10 12:55:43', b'00', b'00');
