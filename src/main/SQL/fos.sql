...
CREATE TABLE `tb_movie`  (
  ...
  `moive_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '电影时长',
  ...
  `moive_video` varchar(1024) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '视频路径',
...
-- Records of tb_movie
-- ----------------------------
INSERT INTO `tb_movie` VALUES (2001, '小黄人', 1102, '2008-04-04', '英语', '美国', '120分钟', '大导演', '动画演员', '。。。。', '。。。。');
INSERT INTO `tb_movie` VALUES (2002, '复仇者联盟4', 1102, '2019-04-01', '英语', '美国', '180分钟', '外国导演', '外国演员', '.....', '......');
INSERT INTO `tb_movie` VALUES (2003, '丁丁历险记', 1104, '2004-06-01', '英语', '美国', '160分钟', NULL, NULL, NULL, NULL);
INSERT INTO `tb_movie` VALUES (2004, '傲慢与偏见', 1105, '2017-06-07', '英语', '美国', '150分钟', NULL, NULL, NULL, NULL);
INSERT INTO `tb_movie` VALUES (2005, '我不是药神', 1105, '2019-01-16', '中文', '中国', '180分钟', NULL, NULL, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3005 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '评论表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tb_movie_comment
-- ----------------------------
INSERT INTO `tb_movie_comment` VALUES (3001, 2005, 1003, '国产良心之作！好评！', '2019-05-31 09:51:19', 5, 0);
INSERT INTO `tb_movie_comment` VALUES (3002, 2002, 1001, '期待很久啦！', '2019-03-12 09:52:17', 5, 0);
INSERT INTO `tb_movie_comment` VALUES (3003, 2004, 1002, '与经典相差太大', '2018-04-01 09:52:53', 2, 0);
INSERT INTO `tb_movie_comment` VALUES (3004, 2003, 1002, 'hhhh 很有趣！！', '2010-02-17 09:53:27', 4, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1004 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '用户表' ROW_FORMAT = Compact;
